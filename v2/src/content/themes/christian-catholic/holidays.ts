...
export const christianCatholicHolidays: HolidayList = [
  ...
  { date: "02-02", name: "Candlemas",                 tradition: "christian-catholic", isMajor: false, sentence: "Today is Candlemas — the Presentation of Jesus in the Temple. We bless candles and remember that Jesus is the Light of the World." },
  ...
  { date: "04-25", name: "St. Mark the Evangelist",  tradition: "christian-catholic", isMajor: false, sentence: "Today is the feast of St. Mark, who wrote the Gospel that tells the story of Jesus. His symbol is a lion." },
  ...
  { date: "05-01", name: "May Crowning of Mary",     tradition: "christian-catholic", isMajor: false, sentence: "Today begins May — the month of Mary. Families crown Mary with flowers as queen of heaven and ask for her blessing." },
