...
export const indiaHolidays: HolidayList = [
  ...
  { date: "05-03", name: "Rangoli at the door",     tradition: "universal", isMajor: false, sentence: "In India, families draw colorful rangoli patterns at their doorways to welcome guests and good fortune." },
  ...
  { date: "05-17", name: "Mango lassi",             tradition: "universal", isMajor: false, sentence: "Mango lassi is a sweet, cool drink loved across India — perfect for a warm summer day." },
  { date: "05-31", name: "The Indian tricolor",     tradition: "universal", isMajor: false, sentence: "India's flag has three colors: saffron for courage, white for peace, and green for the land. The blue wheel in the middle is the Ashoka Chakra." },
  { date: "06-07", name: "Music of India",          tradition: "universal", isMajor: false, sentence: "The tabla and sitar are two famous instruments of India. The tabla keeps the beat, and the sitar makes beautiful melodies." },
  ...
  { date: "06-22", name: "Auto-rickshaws of India", tradition: "universal", isMajor: false, sentence: "In Indian cities, bright yellow-and-green auto-rickshaws zip through the streets carrying families everywhere they need to go." },
  { date: "06-28", name: "A cup of chai",           tradition: "universal", isMajor: false, sentence: "Chai is more than tea in India — it's brewed with spices like cardamom and ginger, and shared with family and friends every day." },
  { date: "07-03", name: "Samosas of India",        tradition: "universal", isMajor: false, sentence: "Samosas are crispy triangle pastries filled with potatoes and peas — the most-loved snack in India!" },
  ...
  { date: "07-14", name: "Morning yoga",            tradition: "universal", isMajor: false, sentence: "Yoga began in India and is now practiced all over the world — even kids can do it to start the day strong!" },
  { date: "07-18", name: "Henna patterns",          tradition: "universal", isMajor: false, sentence: "Henna (mehndi) is a beautiful brown paste used to draw delicate patterns on hands — a tradition for weddings and festivals." },
  { date: "07-24", name: "Indian Railways",         tradition: "universal", isMajor: false, sentence: "Indian Railways is one of the biggest train networks in the world — trains carry millions of people across the country every day." },
  { date: "07-31", name: "Classical Indian dance",  tradition: "universal", isMajor: false, sentence: "Bharatanatyam is a classical Indian dance — graceful hand gestures and storytelling movements over 2,000 years old!" },
